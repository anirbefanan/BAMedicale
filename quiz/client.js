...
async function resume(){announce('Restoring your existing quiz session…');try{const r=await request('quiz_resume',eventId,{token:saved.token});await activate(r);}catch{announce('Unable to restore your session. Choose Check availability to retry; your original timer is preserved.');}}
