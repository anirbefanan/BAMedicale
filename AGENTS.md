...
- Run `npm run articles:build` after article-record changes and `npm run articles:check` before commit. Preserve the 16:9 IMAGE FILL hero, compact Latest 5, ten-item audience pagination, canonical `https://bamedicale.com/articles/<slug>.html`, Quick Read, full article navigation, share tools, source PDF, SEO, and sitemap inclusion.
