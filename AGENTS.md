...
- For every added article, infer one or more evidence-based audiences (`PUBLIC`, `DOCTOR`, `HEALTHCARE WORKER`), one controlled primary topic, restrained tags, disease/site, content type, source attribution, excerpt, and source-faithful promotional copy.
