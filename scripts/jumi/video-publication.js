...
function validateManifest(x,root){
  ...
  keys(m.publication,['primaryAudience','primaryDiseaseGroup','primaryTopic','contentType','audienceReviewed','promotion']);keys(m.publication.promotion,['hook','teaser','hashtags']);
