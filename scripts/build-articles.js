...
<head>
  ...
  <link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@400;500;600;700;800&amp;family=Source+Serif+4:wght@400;500;600;700&amp;display=swap" rel="stylesheet">
  <link rel="icon" href="/favicon.ico" sizes="any"><link rel="icon" type="image/png" sizes="32x32" href="/assets/brand/favicon-32.png"><link rel="stylesheet" href="../styles.css?v=immersive-20260902">
...
<body class="route-article">
  ...
  <script src="../content.js?v=doctor-papers-20260901"></script><script src="../content-registry.js"></script><script src="../app.js?v=immersive-20260902"></script>
</body></html>`.replace(/[ \t]+\n/g, "\n");
};
...
Object.values(sourceData.presentations || {}).forEach(presentation => outputs.set(path.join(root, presentation.canonicalUrl), renderPresentationPage({ presentation, event: sourceData.seminars[presentation.eventId], root, domain })));
