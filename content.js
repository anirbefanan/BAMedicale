window.BAMEDICALE_DATA = {
  ...
  seminars: {
    ...
    summary: "A free Zoom webinar for doctors on thyroid nodule diagnosis, including ultrasound TIRADS, BETHESDA classification, and therapy selection.",
    ...
    quota: "Limited to 1,000 participants: 500 specialist doctors and 500 general practitioners.",
    organizer: "Department of Head and Neck",
    host: "Hosted by Dharmais National Cancer Center Hospital.",
    audience: ["Free for doctors. Participants must have a Plataran Sehat account.", "Limited quota: 1,000 participants, with 500 specialist doctors and 500 general practitioners."],
    faculty: [
      ["Keynote speaker", "dr. Eniarti M.Sc., Sp.KJ., M.M.R., QHIA"],
    ...
    outcomes: ["Free registration", "Plataran Sehat account required", "Limited quota for specialist and general practitioners", "Kemenkes accreditation and SKP information on the official poster"],
    ...
    promotion: {
      hook: "What turns a thyroid nodule workup into a good diagnosis?",
