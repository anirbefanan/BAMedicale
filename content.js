window.BAMEDICALE_DATA = {
  ...
  doctorContentCategories: [
    { id: "diagnosis", label: "Diagnosis", area: "Diagnostic advances", icon: "search", description: "Clinical assessment, imaging, tissue acquisition, molecular diagnostics, and the limits of individual tests.", matchTopics: ["Diagnosis", "Imaging", "Early Detection"] },
    { id: "pathology", label: "Pathology", area: "Pathology & cytology", icon: "cell", description: "Histology, cytology, grade, immunophenotyping, biomarkers, and how pathology contributes to decision-making.", matchTopics: ["Pathology", "Cytology", "Biomarkers"] },
    { id: "staging", label: "Staging", area: "Staging", icon: "path", description: "Stage describes disease extent. TNM is commonly used in solid tumor staging, while some malignancies use disease-specific systems.", matchTopics: ["Staging", "TNM"] },
    { id: "therapeutics", label: "Therapeutics", area: "Therapeutics", icon: "scalpel", description: "Surgery, radiation oncology, systemic therapy, treatment selection, toxicity, and supportive care.", matchTopics: ["Treatment", "Treatment Planning", "Surgery", "Radiotherapy", "Systemic Therapy"] },
    { id: "multidisciplinary-care", label: "Multidisciplinary care", area: "Case discussions", icon: "book", description: "Disease-specific clinical questions and multidisciplinary discussion, prepared through reviewed case architecture.", matchTopics: ["Multidisciplinary Care", "Case Discussion", "Care Coordination"] },
  ...
  publicContentCategories: [
    { id: "public-tumor-cancer", anchor: "tumor-cancer", label: "Tumor vs cancer", kicker: "Starting point", area: "Tumor versus cancer", description: "A tumor is an abnormal growth. A tumor may be benign. Cancer is a malignant disease that can invade nearby tissue and may spread.", fallbackHref: "index.html#disease-explorer", fallbackLabel: "Explore body systems", matchTopics: ["Tumor & Cancer Basics", "Neoplasia basics"] },
    { id: "public-signs", anchor: "signs", label: "Signs & symptoms", kicker: "When something changes", area: "Signs and symptoms", description: "Symptoms can have many causes. Persistent, worsening, or unusual changes are reasons to seek clinical advice.", fallbackHref: "search.html", fallbackLabel: "Search a concern", matchTopics: ["Signs and Symptoms"] },
    { id: "public-diagnosis", anchor: "diagnosis", label: "Diagnosis", kicker: "Finding an answer", area: "Diagnosis", description: "History, examination, imaging, laboratory tests, and biopsy each answer different questions. A biopsy is often needed to confirm cancer.", fallbackHref: "clinical.html#diagnosis", fallbackLabel: "See clinical depth", matchTopics: ["Diagnosis", "Imaging", "Early Detection", "Pathology"] },
    { id: "public-treatment", anchor: "treatment", label: "Treatment", kicker: "Planning care", area: "Treatment options", description: "Depending on disease type and stage, care may include surgery, radiotherapy, systemic therapy, supportive care, or a combination.", fallbackHref: "resources.html", fallbackLabel: "Open treatment resources", matchTopics: ["Treatment", "Treatment Planning", "Surgery", "Radiotherapy", "Systemic Therapy"] },
    { id: "public-living", anchor: "living", label: "Living with cancer", kicker: "Beyond treatment", area: "Living with cancer", description: "Supportive care, follow-up, rehabilitation, survivorship, advanced disease, and caregiver support remain part of the wider journey.", fallbackHref: "resources.html#patient", fallbackLabel: "Find patient resources", matchTopics: ["Supportive Care", "Follow-up", "Rehabilitation", "Survivorship"] },
  ...
  healthcareWorkerContentCategories: [
    { id: "healthcare-clinical-context", anchor: "clinical-context", label: "Clinical context", area: "Clinical context", icon: "book", description: "Understand how symptoms, diagnoses, and treatment plans fit into a patient’s wider care journey without stepping beyond role-specific responsibilities.", emptyLabel: "Professional foundation", matchContentTypes: ["Article", "Case report", "Scientific paper", "Seminar", "Video", "eBook", "Resource"] },
    { id: "healthcare-testing", anchor: "testing", label: "Testing context", area: "Tests and investigations", icon: "search", description: "Learn what imaging, laboratory testing, pathology, and other investigations can contribute to communication, preparation, and follow-up.", emptyLabel: "Care context", matchTopics: ["Diagnosis", "Imaging", "Pathology", "Early Detection", "Laboratory"] },
    { id: "healthcare-care-pathways", anchor: "care-pathways", label: "Care pathways", area: "Care pathways", icon: "path", description: "Follow the connections between assessment, diagnosis, treatment, monitoring, rehabilitation, and supportive care across changing clinical needs.", emptyLabel: "Practical orientation", matchTopics: ["Treatment", "Treatment Planning", "Supportive Care", "Rehabilitation", "Follow-up"] },
  ...
  ebooks: [
    { id: "ebook-clinical-oncology-foundations", slug: "clinical-oncology-foundations", title: "Clinical Oncology Foundations", publicationStatus: "planned", primaryAudience: "DOCTOR", audience: "Medical students and general physicians", primaryDiseaseGroup: "cancer-neoplastic", diseaseCondition: "Cancer across organ systems", topics: ["Diagnosis", "Staging", "Biopsy"], contentType: "eBook", cover: "assets/ebooks/clinical-oncology-foundations.png", price: "Rp149.000", state: "Planned release", text: "A structured foundation for cancer terminology, diagnostic workup, staging, biopsy, and risk communication." },
    { id: "ebook-practical-surgical-oncology", slug: "practical-surgical-oncology", title: "Practical Surgical Oncology", publicationStatus: "planned", primaryAudience: "DOCTOR", audience: "Residents and surgical learners", primaryDiseaseGroup: "cancer-neoplastic", diseaseCondition: "Solid tumor", topics: ["Surgery", "Treatment Planning"], contentType: "eBook", cover: "assets/ebooks/practical-surgical-oncology.png", price: "Rp249.000", state: "Planned release", text: "A study pathway for surgical thinking, multidisciplinary planning, and perioperative oncology context." },
    { id: "ebook-breast-cancer-clinical-guide", slug: "breast-cancer-clinical-guide", title: "Breast Cancer Clinical Guide", publicationStatus: "planned", primaryAudience: "DOCTOR", audience: "Clinicians and advanced learners", primaryDiseaseGroup: "breast", secondaryDiseaseGroups: ["cancer-neoplastic"], diseaseCondition: "Breast cancer", topics: ["Diagnosis", "Treatment", "Patient Education"], contentType: "eBook", cover: "assets/ebooks/breast-cancer-clinical-guide.png", price: "Rp299.000", state: "Planned release", text: "A focused guide to breast symptoms, diagnostic pathways, treatment concepts, and patient education." }
  ],
  seminars: {
    ...
    format: "Live webinar",
    title: "Management of Thyroid Nodules — How to Make a Good Diagnosis?",
    previousTitles: ["Management of Thyroid Nodules — How to Make an Accurate Diagnosis?"],
