(function(root,factory){
  ...
  function buildSnapshot(data,scope="all",now=Date.now()){
    ...
    return{scope,events,registrants,notifications,quizResults,downloads,community,metrics,journeys,reports,signals,toolsByEvent};
  }
