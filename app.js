...
function shell() {
  ...
  document.querySelectorAll("[data-footer]").forEach((target) => {
    target.innerHTML = `<footer class="site-footer">
      ...
      <div class="footer-group"><h2>Explore</h2><a href="${navigationHref("clinical.html")}">For Doctors</a><a href="${navigationHref("healthcare-workers.html")}">For Healthcare Workers</a><a href="${navigationHref("public.html")}">For Public</a><a href="${navigationHref("library.html")}">Library &amp; Articles</a><a href="${navigationHref("seminar.html")}">Courses &amp; Seminars</a><a href="${navigationHref("ebooks.html")}">eBooks</a><a href="${navigationHref("videos.html")}">Videos</a><a href="${navigationHref("resources.html")}">Resources</a></div>
...
function renderLibrary() {
  ...
  const update = ({ syncUrl = false } = {}) => {
    ...
    target.querySelectorAll('.library-video-media img').forEach(image => {
      const fit = () => image.classList.toggle('is-portrait', image.naturalHeight > image.naturalWidth);
